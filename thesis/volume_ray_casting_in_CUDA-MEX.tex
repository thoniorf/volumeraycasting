...
{\linespace \lstset{language=C++,
                ...
                morekeywords={mxREAL , mxArray , __global__ , __device__ , __host__, std::, Vector3, Camera, Grid,}
...
The threshold value let users display all voxels with intensity value greater or equal then the threshold, as stated in %TODO cite display of surfaces from volume data
this produces 3D regions of opaque voxels, where the outermost layer of which is the desired surface.
The classification procedure employed is this work wouldn't be able to display concentric semitransparent surfaces or object, as reported by Levoy in %TODO cite display of surfaces from volume data
